...
namespace INTEX.Models
{
    public partial class postgresContext : DbContext
    {
        ...
        public virtual DbSet<Bodyanalysischartreal> Bodyanalysischartreal { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("User ID=postgres;Password=ILoveIntex!;Host=database-1.cwyrmxcmisvd.us-east-2.rds.amazonaws.com;Port=5432;Database=postgres;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bodyanalysischartreal>(entity =>
            {
                entity.ToTable("bodyanalysischartreal");
                ...
                entity.Property(e => e.DateofExamination).HasColumnType("date");
                ...
                entity.Property(e => e.Perservationindex)
